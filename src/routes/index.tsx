  ...
  return (
    <div className="w-full overflow-x-hidden">
      ...
      <section className="relative isolate overflow-hidden w-full">
        ...
        {/* Removed max-w-7xl and px-4 sm:px-6 to hit full width */}
        <div className="w-full flex min-h-[88vh] flex-col justify-center py-24 px-4 sm:px-8">
      ...
      {/* WHY */}
      <section className="border-t border-border/50 bg-surface/30 py-24 w-full">
        {/* Adjusted padding to maintain clean breathing room next to structural edges */}
      ...
      {/* PLANS */}
      <section className="border-y border-border/50 bg-surface/30 py-24 w-full">
        <div className="w-full px-4 sm:px-8">
          <div className="max-w-2xl">
          ...
          <div className="mt-12 grid gap-6 sm:grid-cols-2 lg:grid-cols-4 w-full">
            {[
              {
                id: "monthly",
                name: "Monthly",
      ...
      <section className="py-24 w-full">
        <div className="w-full px-4 sm:px-8">
          ...
          <div className="mt-10 grid gap-5 sm:grid-cols-2 lg:grid-cols-3 w-full">
            {testimonials.map((t) => (
      ...
      {/* CONTACT CTA */}
      <section className="border-t border-border/50 bg-surface/30 py-24 w-full">
        <div className="w-full grid items-center gap-10 px-4 sm:px-8 md:grid-cols-2">
          <div>
          ...
          <div className="aspect-video overflow-hidden rounded-2xl border border-border w-full">
            <iframe
              title="Map"
